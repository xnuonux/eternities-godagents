...
export async function prepareOperatorArtifactFixture(t) {
  ...
  return { ...prepared, workspace, instanceId, missionId: request.mission.missionId, root, creation, distribution };
}
