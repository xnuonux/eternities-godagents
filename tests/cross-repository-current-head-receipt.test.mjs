...
const certificatePath = join(godagentsRoot, 'integrations', 'cross-repository-current-head-v1.json');
...
const certificateDigest = '0b7ee1bda659cb1a3aa5ef3834eb4bc0a55d5d6e056182665931ada481cc61cd';

test('committed cross-repository certificate is canonical and verifies its bound evidence', async () => {
